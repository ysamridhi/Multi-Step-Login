    ...
    <footer className="text-start bg-gray-100  text-slate-500">
            ...
            >
              ...
              >
                <p className="font-poppins text-pink-400 text-lg">
                  <img src={logo} alt="Dribble"  />
                </p>
              </a>

              <p className="text-left">
                Dribble is the world's leading community for creative to share ,
                grow and get hired
              </p>
              <div className="mt-4">
                <ul className="flex gap-5">
                  ...
                  <li>
                    <svg
                      className="h-6 w-5 hover:text-black"
                      fill="gray"
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 496 512"
                    >
      ...
      <div className="flex justify-between px-2 items-center border-t p-3 border-gray-400 text-slate-600">
        ...
        <p className="flex items-center">
          <span className="font-bold text-black mr-2">20,501,853</span> shots
          dribbled{" "}
          <span className="">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="gray"
              className="w-5 h-5 ml-2 bg-pink-700 rounded-md"
              viewBox="0 0 512 512"
            >
